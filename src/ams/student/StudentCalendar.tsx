                ...
                {loading ? (
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)' }}>
                        {cells.map((day, i) => {
                            ...
                            return (
                                <div key={i} style={{ height: 72, borderBottom: '1px solid var(--gray-100)', borderRight: '1px solid var(--gray-100)', padding: '10px 12px', background: status ? STATUS_COLOR[status] + '12' : isWeekend ? 'var(--gray-50)' : 'transparent', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
